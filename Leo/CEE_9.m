...
xlabel("$t (\mathrm{s})$",'Interpreter','latex');
ylabel("$(\mathrm{rad})$",'Interpreter','latex');
saveas(gcf,'./figures/9_4_angles.png');
hold off;
...
plot(tnoise,xnoise(:,[1 3]),'--','LineWidth',3);
legend({"$\alpha_{opt}$","$\beta_{opt}$","$\alpha$","$\beta$"},'Interpreter','latex');
xlabel("$t (\mathrm{s})$",'Interpreter','latex');
ylabel("$(\mathrm{rad})$",'Interpreter','latex');
saveas(gcf,'./figures/9_5_angles.png');
hold off;
...
plot(tnoise,unoise,'--','LineWidth',3);
legend({"$u_{opt}$","$u$"},'Interpreter','latex');
xlabel("$t (\mathrm{s})$",'Interpreter','latex');
ylabel("$(V)$",'Interpreter','latex');
saveas(gcf,'./figures/9_5_u.png');
